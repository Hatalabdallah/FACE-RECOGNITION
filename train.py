...
class Train:
    def __init__(self, root):
        ...
        img_top = Image.open("./college images/train4.jpg")
        ...
        img_bottom = Image.open("./college images/employee2.jpg")
    ...
    def train_classifier(self):
        ...
        clf = cv2.faces.LBHFaceRecognizer_create()
        clf.train(faces, ids)
        clf.write("classifier.xml")
        cv2.destroyAllWindows()
        messagebox.showinfo('Result', "Training Data Set Complete!", parent = self.root)
